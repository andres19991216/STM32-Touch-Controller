...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/audioPlay.cyclo ./Core/Src/audioPlay.d ./Core/Src/audioPlay.o ./Core/Src/audioPlay.su ./Core/Src/base64.cyclo ./Core/Src/base64.d ./Core/Src/base64.o ./Core/Src/base64.su ./Core/Src/fatfs_sd.cyclo ./Core/Src/fatfs_sd.d ./Core/Src/fatfs_sd.o ./Core/Src/fatfs_sd.su ./Core/Src/files.cyclo ./Core/Src/files.d ./Core/Src/files.o ./Core/Src/files.su ./Core/Src/freertos.cyclo ./Core/Src/freertos.d ./Core/Src/freertos.o ./Core/Src/freertos.su ./Core/Src/lcdUartComm.cyclo ./Core/Src/lcdUartComm.d ./Core/Src/lcdUartComm.o ./Core/Src/lcdUartComm.su ./Core/Src/m2m_ble.cyclo ./Core/Src/m2m_ble.d ./Core/Src/m2m_ble.o ./Core/Src/m2m_ble.su ./Core/Src/main.cyclo ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/sgtl5000.cyclo ./Core/Src/sgtl5000.d ./Core/Src/sgtl5000.o ./Core/Src/sgtl5000.su ./Core/Src/stm32f4xx_hal_msp.cyclo ./Core/Src/stm32f4xx_hal_msp.d ./Core/Src/stm32f4xx_hal_msp.o ./Core/Src/stm32f4xx_hal_msp.su ./Core/Src/stm32f4xx_hal_timebase_tim.cyclo ./Core/Src/stm32f4xx_hal_timebase_tim.d ./Core/Src/stm32f4xx_hal_timebase_tim.o ./Core/Src/stm32f4xx_hal_timebase_tim.su ./Core/Src/stm32f4xx_it.cyclo ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/stm32f4xx_it.su ./Core/Src/syscalls.cyclo ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32f4xx.cyclo ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/system_stm32f4xx.su
